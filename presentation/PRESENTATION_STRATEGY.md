...
- Υπάρχουν τίτλος, roadmap, ερευνητικά ερωτήματα, πλαίσιο προβλήματος, βιβλιογραφία, μεθοδολογία, dataset, αποτελέσματα, σύνθεση, συμπεράσματα και τελική διαφάνεια.
...
> Αρχικά θα παρουσιάσω τα ερευνητικά ερωτήματα που οργανώνουν τη μελέτη. Μετά θα δείξω γιατί η ανίχνευση απάτης είναι δύσκολο πρόβλημα, πώς τοποθετείται στη βιβλιογραφία, και στη συνέχεια θα περάσω στο dataset, τη μεθοδολογία, τα πειράματα, τα αποτελέσματα και τα συμπεράσματα. Στο τέλος θα δείξω ένα σύντομο live demo του pipeline.

Κράτησέ το κάτω από 25 δευτερόλεπτα.

### Διαφάνεια 3 - Ερευνητικά Ερωτήματα
